...
void drawText(
  ...
  int maxLines = getMaxLinesContent(text);
  if (subtitle != null) {
    maxLines++;
  }
...
void _loadMarkerImage(int? index, CartesianSeriesRenderer seriesRenderer,
  ...
  if ((trackballBehavior != null &&
      ...
      (series.markerSettings != null &&
          ...
          series.markerSettings.image != null)) {
    calculateImage(index, seriesRendererDetails.stateProperties,
        seriesRendererDetails, trackballBehavior);
  }
}
...
void renderStackingRectSeries(
  ...
  if (strokePaint != null && animationFactor > 0) {
    if (seriesRendererDetails.dashArray![0] != 0 &&
      ...
      if (currentPoint.y != 0 && series.animationDuration > 0)
        animateStackedRectSeries(
          canvas,
          segmentRect,
          strokePaint,
