...
void _triggerMultiLabelRenderCallback(
  ...
  for (int i = 0; i < visibleAxisMultiLevelLabels.length; i++) {
    ...
    if (axisRendererDetails.axis.multiLevelLabelFormatter != null) {
      ...
      subTitle = chartAxisLabel.subtitle;
      subTitleTextStyle = chartAxisLabel.subtitleStyle;
    }

    final Size textSize =
        measureText(actualText, labelTextStyle, 0, subTitle, subTitleTextStyle);
    if (axisRendererDetails.orientation == AxisOrientation.horizontal) {
    ...
    visibleAxisMultiLevelLabels[i].subtitle = subTitle;
    visibleAxisMultiLevelLabels[i].subtitleStyle = subTitleTextStyle;
  }
}
...
void _drawMultiLevelLabelText(
  ...
  drawText(
    ...
    renderText,
    textOffset!,
    multiLevelLabel.textStyle!,
    0,
    null,
    multiLevelLabel.subtitle,
    multiLevelLabel.subtitleStyle,
  );
}
